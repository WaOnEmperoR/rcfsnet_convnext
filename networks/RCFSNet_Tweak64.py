...
#         self.stem_upsample = nn.Upsample(scale_factor=2)
        ...
        self.conv96to64 = conv1x1(96, 64)
        self.conv192to128 = conv1x1(192, 128)
        self.conv384to256 = conv1x1(384, 256)
        self.conv768to512 = conv1x1(768, 512)
...
#         hd5 = self.MSCE(h5)
        ...
        h1_up_fit = self.conv96to64(h1_up)
        
        h2 = self.stage1(h1)
        h2_fit = self.conv96to64(h2)
        
        h3 = self.maxpool1(h2)
        h3 = self.stage2(h3)
        h3_fit = self.conv192to128(h3)
        
        h4 = self.maxpool2(h3)
        h4 = self.stage3(h4)
        h4_fit = self.conv384to256(h4)
        
        h5 = self.maxpool3(h4)
        h5 = self.stage4(h5)
        h5_fit = self.conv768to512(h5)
        
        hd5 = self.MSCE(h5_fit)
        
        m2 = self.FSFF_2(h1_up_fit, h2_fit, h3_fit, h4_fit, h5_fit) #320  256
        m3 = self.FSFF_3(h1_up_fit, h2_fit, h3_fit, h4_fit, h5_fit) #320  128
        m4 = self.FSFF_4(h1_up_fit, h2_fit, h3_fit, h4_fit, h5_fit) #320   64
        ...
        d1 = self.relu(self.conv64_2(torch.cat([self.decoder2(d2), h1_up_fit], dim=1)))  # 256  64   1
