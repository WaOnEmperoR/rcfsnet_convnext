...
def lunwen3():
    return RCFSNet_CN_Small_ScaleSen()
...
if __name__ == "__main__":
    ...
    RCFSNet_CN_Small_ScaleSen = RCFSNet_CN_Small_ScaleSen()
    predicted = RCFSNet_CN_Small_ScaleSen(a)
