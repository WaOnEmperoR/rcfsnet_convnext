...
#         print("end d_all")
        ...
        main_out = F.sigmoid(self.main_head(sum_shape))
...
def lunwen3():
    return RCFSNet_CN_Tiny_ScaleSen()
...
if __name__ == "__main__":
    ...
    RCFSNet_CN_Tiny_ScaleSen = RCFSNet_CN_Tiny_ScaleSen()
    predicted = RCFSNet_CN_Tiny_ScaleSen(a)
