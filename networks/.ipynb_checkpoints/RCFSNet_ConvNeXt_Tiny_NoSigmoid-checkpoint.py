...
#         print("end d_all")
        ...
        main_out = self.main_head(d1 + self.conv5(self.hd5_d1(hd5)) + self.conv4(self.hd4_d1(d4)) + self.conv3(self.hd3_d1(d3)) + self.conv2(self.hd2_d1(d2)))

#         main_out = self.main_head(self.conv5(self.hd5_d1(hd5)) + self.conv4(self.hd4_d1(d4)) + self.conv3(self.hd3_d1(d3)))
...
#         print("decoder block before conv1x1")
#         print(x.shape)
...
if __name__ == "__main__":
    ...
    RCFSNet_CN_Tiny_NoSigmoid = RCFSNet_CN_Tiny_NoSigmoid()
    predicted = RCFSNet_CN_Tiny_NoSigmoid(a)
