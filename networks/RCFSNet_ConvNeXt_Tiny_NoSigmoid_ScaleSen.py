...
class RCFSNet_CN_Tiny_NoSigmoid_ScaleSen(nn.Module):
    def __init__(self, num_classes=1, ccm=True, norm_layer=nn.BatchNorm2d, is_training=True, expansion=2,
                 base_channel=32):
        super(RCFSNet_CN_Tiny_NoSigmoid_ScaleSen, self).__init__()
...
if __name__ == "__main__":
    ...
    RCFSNet_CN_Tiny_NoSigmoid_ScaleSen = RCFSNet_CN_Tiny_NoSigmoid_ScaleSen()
    predicted = RCFSNet_CN_Tiny_NoSigmoid_ScaleSen(a)
