...
from RCFSNet_ConvNeXt_Small import RCFSNet_CN_Small
...
solver = TTAFrame(RCFSNet_CN_Small)

solver.load('../Training/weights/RCFSNet_DG2_CnSmall_v01_50epoch.th')

target = 'submits/RCFSNet_CnSmall_DG_v01/'
...
df.to_csv('rcfsnet_cnsmall_test_DG_v01.csv')