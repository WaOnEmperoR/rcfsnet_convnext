...
solver.load('../Training/weights/RCFSNet_DG2_CnSmall_double_pos_030_v01_50epoch.th')

target = 'submits/RCFSNet_CnSmall_DG_double_pos_030_v01/'
...
df.to_csv('rcfsnet_cnsmall_test_DG_double_pos_030_v01.csv')