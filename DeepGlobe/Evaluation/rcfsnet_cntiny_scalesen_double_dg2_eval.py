...
from RCFSNet_ConvNeXt_Tiny_NoSigmoid_ScaleSen import RCFSNet_CN_Tiny_NoSigmoid_ScaleSen
...
solver = TTAFrame(RCFSNet_CN_Tiny_NoSigmoid_ScaleSen)

solver.load('../Training/weights/RCFSNet_DG2_CnTiny_ScaleSen_double_pos_025_v01_50epoch.th')

target = 'submits/RCFSNet_CnTiny_ScaleSen_DG_double_pos_025_v01/'
...
df.to_csv('rcfsnet_cntiny_scalesen_test_DG_double_pos_025_v01.csv')