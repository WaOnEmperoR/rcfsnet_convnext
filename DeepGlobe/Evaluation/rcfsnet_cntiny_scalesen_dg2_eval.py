...
solver.load('../Training/weights/RCFSNet_DG2_CnTiny_ScaleSen_v01_50epoch.th')

target = 'submits/RCFSNet_CnTiny_ScaleSen_DG_v01/'
...
df.to_csv('rcfsnet_cntiny_scalesen_test_DG_v01.csv')