...
from RCFSNet_ConvNeXt_Tiny import RCFSNet_CN_Tiny
...
solver = TTAFrame(RCFSNet_CN_Tiny)

solver.load('../Training/weights/RCFSNet_DG2_CnTiny_v01_50epoch.th')

target = 'submits/RCFSNet_CnTiny_DG_v01/'
...
df.to_csv('rcfsnet_cntiny_test_DG_v01.csv')