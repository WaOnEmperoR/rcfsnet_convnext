...
solver.load('../Training/weights/RCFSNet_DG2_CnSmall_ScaleSen_v01_50epoch.th')

target = 'submits/RCFSNet_CnSmall_ScaleSen_DG_v01/'
...
df.to_csv('rcfsnet_cnsmall_scalesen_test_DG_v01.csv')