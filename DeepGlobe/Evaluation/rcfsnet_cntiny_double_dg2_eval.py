...
from RCFSNet_ConvNeXt_Tiny_NoSigmoid import RCFSNet_CN_Tiny_NoSigmoid
...
solver = TTAFrame(RCFSNet_CN_Tiny_NoSigmoid)

solver.load('../Training/weights/RCFSNet_DG2_CnTiny_double_pos_020_v01_50epoch.th')

target = 'submits/RCFSNet_CnTiny_DG_double_pos_020_v01/'
...
df.to_csv('rcfsnet_cntiny_test_DG_double_pos_020_v01.csv')