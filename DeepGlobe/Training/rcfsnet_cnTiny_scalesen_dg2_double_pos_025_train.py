...
from networks.RCFSNet_ConvNeXt_Tiny_NoSigmoid_ScaleSen import RCFSNet_CN_Tiny_NoSigmoid_ScaleSen
...
solver = MyFrame(RCFSNet_CN_Tiny_NoSigmoid_ScaleSen, double_loss, 2e-4)
batchsize = 6  
...
NAME = 'RCFSNet_DG2_CnTiny_ScaleSen_double_pos_025_v01_50epoch'
print(NAME)
