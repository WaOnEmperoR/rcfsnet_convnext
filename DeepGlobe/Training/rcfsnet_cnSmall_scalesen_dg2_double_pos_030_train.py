...
from networks.RCFSNet_ConvNeXt_Small_NoSigmoid_ScaleSen import RCFSNet_CN_Small_NoSigmoid_ScaleSen
from framework import MyFrame
from loss import double_loss
...
solver = MyFrame(RCFSNet_CN_Small_NoSigmoid_ScaleSen, double_loss, 2e-4)
batchsize = 6  

dataset = ImageFolder(root_path='../../DG2/', datasets='DRIVE')
...
NAME = 'RCFSNet_DG2_CnSmall_ScaleSen_double_pos_030_v01_50epoch'
print(NAME)
