...
from networks.RCFSNet_ConvNeXt_Small_NoSigmoid import RCFSNet_CN_Small_NoSigmoid
from framework import MyFrame
from loss import double_loss, double_loss_assigned
...
solver = MyFrame(RCFSNet_CN_Small_NoSigmoid, double_loss_assigned, 2e-4)
batchsize = 6  
...
NAME = 'RCFSNet_DG2_CnSmall_double_pos_030_v01_50epoch'
print(NAME)
