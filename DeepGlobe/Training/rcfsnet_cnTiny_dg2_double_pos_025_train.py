...
from networks.RCFSNet_ConvNeXt_Tiny_NoSigmoid import RCFSNet_CN_Tiny_NoSigmoid
...
solver = MyFrame(RCFSNet_CN_Tiny_NoSigmoid, double_loss, 2e-4)
batchsize = 6  
...
NAME = 'RCFSNet_DG2_CnTiny_double_pos_025_v01_50epoch'
print(NAME)
