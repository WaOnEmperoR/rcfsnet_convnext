...
from networks.RCFSNet_ConvNeXt_Small_ScaleSen import RCFSNet_CN_Small_ScaleSen
...
solver = MyFrame(RCFSNet_CN_Small_ScaleSen, dice_bce_loss, 2e-4)
batchsize = 6  
...
NAME = 'RCFSNet_DG2_CnSmall_ScaleSen_v01_50epoch'
print(NAME)
