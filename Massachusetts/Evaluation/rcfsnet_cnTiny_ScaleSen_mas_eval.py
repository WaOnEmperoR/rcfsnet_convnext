...
from RCFSNet_ConvNeXt_Tiny_ScaleSen import RCFSNet_CN_Tiny_ScaleSen
...
solver = TTAFrame(RCFSNet_CN_Tiny_ScaleSen)

solver.load('../Training/weights/RCFSNet_Mas_CnTiny_ScaleSen_v02_100epoch.th')

target = 'submits/RCFSNet_CnTiny_ScaleSen_Mas_v02/'
...
df.to_csv('rcfsnet_CnTiny_ScaleSen_test_Mas_v02.csv')