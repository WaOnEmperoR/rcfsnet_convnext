...
from RCFSNet_ConvNeXt_Small_ScaleSen import RCFSNet_CN_Small_ScaleSen
...
solver = TTAFrame(RCFSNet_CN_Small_ScaleSen)

solver.load('../Training/weights/RCFSNet_Mas_CnSmall_ScaleSen_v02_100epoch.th')

target = 'submits/RCFSNet_CnSmall_ScaleSen_Mas_v02/'
...
df.to_csv('rcfsnet_CnSmall_ScaleSen_test_Mas_v02.csv')